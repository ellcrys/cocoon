...
type PutTransactionParams struct {
	...
	RevisionID   string         `protobuf:"bytes,4,opt,name=revisionID" json:"revisionID,omitempty"`
}
...
type Transaction struct {
	...
	RevisionTo     string `protobuf:"bytes,12,opt,name=revisionTo" json:"revisionTo,omitempty"`
}
