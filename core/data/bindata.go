...
func cocoonJobJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "cocoon.job.json", size: 1481, mode: os.FileMode(420), modTime: time.Unix(1486976539, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
