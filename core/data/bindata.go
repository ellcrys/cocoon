...
func cocoonJobJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "cocoon.job.json", size: 1868, mode: os.FileMode(420), modTime: time.Unix(1487172299, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
