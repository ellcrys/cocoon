...
func bindataGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "bindata.go", size: 0, mode: os.FileMode(420), modTime: time.Unix(1487413916, 0)}
...
func cocoonJobJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "cocoon.job.json", size: 2938, mode: os.FileMode(420), modTime: time.Unix(1487413835, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
