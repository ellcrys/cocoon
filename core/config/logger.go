...
func makeLogger(module, prefix string, format logging.Formatter) *logging.Logger {
...
func MakeLogger(module, prefix string) *logging.Logger {
	return makeLogger(module, prefix, format3)
}
...
func MakeLoggerMessageOnly(module, prefix string) *logging.Logger {
	return makeLogger(module, prefix, format2)
}
